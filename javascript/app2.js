...
$(document).ready(function() {
    ...
    var queryURL = 'https://api.themoviedb.org/3/search/movie?api_key=0ff882446ecc7061a134cf692047205b&query=' + movie_name;
    ...
    $.ajax({
        ...
        //info from OMDB
        var queryURL2 = "https://www.omdbapi.com/?t=" + movie_name + "&apikey=trilogy";
        ...
        var queryURL = "https://newsapi.org/v2/everything?q=" + movie_name + "&sortBy=popularity&apiKey=215fb6a8533441b8b97d0c058a476321";
        $.ajax({
            url: queryURL,
            method: "GET"
        }).then(function (response) {
